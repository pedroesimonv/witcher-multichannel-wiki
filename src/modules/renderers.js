...
/**
 * MÓDULO: Renderizado de Libros
 */
export function renderLibros() {
...
/**
 * MÓDULO: Renderizado de Personajes (Cartas Gwent)
 */
export function renderPersonajes() {
...
/**
 * MÓDULO: Renderizado de Adaptaciones
 */
export function renderAdaptaciones() {
